...
<div id="win10-login">
  ...
  <div id="win10-login-box">
    ...
    <p style="font-size: 24px;color: white;text-align: center">管理员登录</p>
    <form action="LoginServlet" method="post">

	  <!--账号-->
      <input type="text" placeholder="请输入账号" class="login-username" name="adname" id="adname">
      <!--密码-->
      <input type="password" placeholder="请输入密码" class="login-password" name="adpwd" id="adpwd">
      <!--登陆按钮-->
