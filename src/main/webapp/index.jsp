...
<div align="center">
  <%
    ...
    int price;
%>
  <a href="pwdchange.jsp">修改密码</a>
  <a href="user.jsp">用户管理</a>
  <a href="add.html">增加商品</a>
  <a href="getgoods.jsp">商品进货</a>
  <a href="sellgoods.jsp">销售额统计</a>
</div>
<table border="1" align="center">
  <tr>
    ...
    <td width="126"><div align="center">管理该种类</div></td>
  <tr>
<%
...
<tr>
    ...
    <td><div align="center"><a href="goodskind.jsp?type=<%=type%>">商品分类管理</a></div></td>
  <tr>
